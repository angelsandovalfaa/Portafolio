          ...
          <div className="map-info">
            <div className="map-info-item">
              <div className="w-layout-grid map-links-grid">
                <div>
                  <div className="map-info-heading">San Miguel, Buenos Aires</div>
                  <div>Argentina</div>
                </div>
                <div>
                  <a
                    href="https://www.google.com/maps?q=San+Miguel,+Buenos+Aires,+Argentina"
                    target="_blank"
                    rel="noreferrer"
            ...
            <div className="map-info-item is-last">
              <div className="w-layout-grid map-links-grid">
                <div className="map-links">
                  <a href="mailto:angelsandovalfaa@gmail.com" className="text-link">
                    angelsandovalfaa@gmail.com
                  </a>
                </div>
                <div className="html-embed w-embed w-script">
                  <a
                    ...
                    onClick={(e) => {
                      e.preventDefault()
                      window.open('https://wa.me/5493624062848', '_blank')
                    }}
                  >
                    <img src="/assets/icons/whatsapp.svg" alt="WhatsApp" className="wa-icon" />
                  </a>
                </div>
              </div>
            </div>
                ...
                <div className="app-wrap">
                  <div className="app-icon w-embed">
                    <svg viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <rect width="40" height="40" rx="0" fill="#006699"></rect>
                      <path
                        fillRule="evenodd"
                        clipRule="evenodd"
            ...
            <div>
              <div className="app-list">
                <div className="app-wrap">
                  <div className="app-icon w-embed">
                    <svg viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <rect width="40" height="40" rx="0" fill="white"></rect>
                      <path
          ...
          <div className="contact-card-grid">
            <div className="contact-card-list">
              <div className="app-list">
                <div className="app-wrap">
                  <img
                    src="https://cdn.prod.website-files.com/66e2e525ff88cd2d1a4c79ce/66e2e525ff88cd2d1a4c7a1c_%D0%B7%D0%B0%D0%B2%D0%B0%D0%BD%D1%82%D0%B0%D0%B6%D0%B5%D0%BD%D0%BD%D1%8F.png"
                    loading="lazy"
                    alt=""
                  />
                  <div className="app-icon w-embed">
                    <svg viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <rect width="40" height="40" rx="0" fill="#D15584"></rect>
            ...
            <div className="contact-card-square">
              <img
                loading="lazy"
                sizes="100vw"
                srcSet="https://cdn.prod.website-files.com/66e2e525ff88cd2d1a4c79ce/66e2e525ff88cd2d1a4c7a61_Screen%2520Shot%25202024-02-18%2520at%252014.28.11%2520PM-p-500.png 500w, https://cdn.prod.website-files.com/66e2e525ff88cd2d1a4c79ce/66e2e525ff88cd2d1a4c7a61_Screen%2520Shot%25202024-02-18%2520at%252014.28.11%2520PM-p-800.png 800w, https://cdn.prod.website-files.com/66e2e525ff88cd2d1a4c79ce/66e2e525ff88cd2d1a4c7a61_Screen%20Shot%202024-02-18%20at%2014.28.11%20PM.png 911w"
                alt=""
                className="thumb-image"
                src="https://cdn.prod.website-files.com/66e2e525ff88cd2d1a4c79ce/66e2e525ff88cd2d1a4c7a61_Screen%20Shot%202024-02-18%20at%2014.28.11%20PM.png"
              />
              <div className="outline-10px"></div>
            </div>
          </div>
        </div>
      </a>
